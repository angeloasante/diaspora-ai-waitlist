...
export default function People({
	count = 1050, // This will be base (1000) + actual signups
	initialCount = 1000, // Starting animation from base number
	className = "",
}: PeopleProps) {
	...
	return (
		...
		>
			...
			<motion.div className="text-sm md:text-base font-semibold text-muted-foreground">
				Join{" "}
				<motion.span
